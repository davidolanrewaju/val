        ...
        <div onClick={toggleMenu}>
          ...
          <div className={`${isOpen ? 'd-block' : 'd-none'}`}>
            <ul className="list-unstyled pt-2">
              <li>
                <NavLink to="/about#about" className="d-block py-2 ps-4 text-white text-decoration-none">About Us</NavLink>
              </li>
              <li>
                <NavLink to="/customer/feedback" className="d-block py-2 ps-4 text-white text-decoration-none">Trip Feedback</NavLink>
              </li>
              <li>
                <NavLink to="/customer/courier-feedback" className="d-block py-2 ps-4 text-white text-decoration-none">Courier Feedback</NavLink>
              </li>
              <li>
                <NavLink to="/about#services" className="d-block py-2 ps-4 text-white text-decoration-none">Services</NavLink>
              </li>
              <li>
                <NavLink to="/terms" className="d-block py-2 ps-4 text-white text-decoration-none">Terms & Conditions</NavLink>
              </li>
            </ul>
          </div>
        </div>
